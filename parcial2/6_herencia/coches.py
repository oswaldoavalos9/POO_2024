...
METODO CONSTRUCTOR.- Este metodo especial dentro de una clase se utiliza para dar un valor a los atributos del objeto al crearlo, es el primer metodo que se ejecuta al crear el objeto y se manda llamar automaticamente al crearlo, es decir este metodo puede recibir parametros al momento de crear objetos.
...
class Coches:
    ...
    def _init_(self,color,marca,modelo,velocidad,caballaje,plazas):
        ...
        self.plazas=plazas
    #El encapsulamiento o visibilidad es importante que a traves de el es posible que python sepa como utilizar y manipular los atributos y metodos de la clase
    ...
    #Nota 1, para utilizar un atributo privado es necesario usarlo dentro de un atributo publico
...
# clases secundarias, sub clases, hijas
...
class camionetas(Coches):
   def __init__(self, color, marca, modelo, velocidad, caballaje, plazas, eje, capacidadCarga):
      ...
      def setcerrada(self, capacidadCarga):
         self.capacidadCarga = capacidadCarga
